...
- GPT-2 ortalama raw path length: 8501.8
- Pythia ortalama raw path length: 2350.1
- GPT-2 step variability (CV): 0.917
- Pythia step variability (CV): 0.213
- GPT-2 mean abs turn: 0.642
- Pythia mean abs turn: 0.361
...
- GPT-2 category area range: 1.0301
- Pythia category area range: 0.0975
- GPT-2 en genis area veren kategori: Physics
- Pythia en genis area veren kategori: Technology
...
- En iyi grouped category RF accuracy: 0.0925
...
- Model identity icin en guclu ilk 4 feature:
  - within_model_pca_spread: 0.1760
  - norm_geo_dist_min: 0.1400
  - si_step_min_over_mean: 0.1203
  - norm_geo_cos_sim_std: 0.1131
- Category prediction icin en guclu ilk 4 feature:
  - within_model_pca_spread: 0.0679
  - within_model_pca_area: 0.0665
  - within_model_pca_linearity: 0.0629
  - si_turn_abs_mean: 0.0619
